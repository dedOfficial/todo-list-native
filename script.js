...
(function (arrOfTasks) {
  ...
  themeSelector.addEventListener("change", ohThemeSelectHandler);
  ...
  function deleteTask(id) {
    ...
    if (isConfirm) delete objectOfTasks[id];
  ...
  function ohThemeSelectHandler(event) {
    const selectedTheme = themeSelector.value;
    const isConfirmed = confirm(
      `Вы уверены, что хотите изменить текущую тему на ${selectedTheme}?`
    );
    if (!isConfirmed) {
